...
class CateringBottomSheetWidget extends StatefulWidget {
  ...
  const CateringBottomSheetWidget({super.key, required this.product, this.isCampaign = false, this.cart, this.cartIndex, this.inRestaurantPage = false, this.fromReview = false});

  @override
  State<CateringBottomSheetWidget> createState() => _CateringBottomSheetWidgetState();
}
