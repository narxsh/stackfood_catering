import 'package:stackfood_multivendor/common/widgets/catering_bottom_sheet_widget.dart';
...
class CateringWidget extends StatelessWidget {
  ...
  const CateringWidget({super.key, required this.product, required this.isRestaurant, required this.restaurant, required this.index,
            ...
            if(isRestaurant) {
              ...
              if(product!.restaurantStatus == 1){
                ResponsiveHelper.isMobile(context) ? Get.bottomSheet(
                  CateringBottomSheetWidget(product: product, inRestaurantPage: inRestaurant, isCampaign: isCampaign),
                  backgroundColor: Colors.transparent, isScrollControlled: true,
                ) : Get.dialog(
                  Dialog(child: CateringBottomSheetWidget(product: product, inRestaurantPage: inRestaurant)),
                );
              }else{
