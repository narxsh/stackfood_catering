...
import 'package:stackfood_multivendor/common/widgets/catering_widget.dart';
...
class CateringViewWidget extends StatelessWidget {
  ...
  const CateringViewWidget({super.key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ? GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          : isWebRestaurant! ? WebRestaurantWidget(restaurant: restaurants![index]) : CateringWidget(
